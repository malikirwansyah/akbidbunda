...
<div id="content" class="col-lg-12 col-sm-12">
 ...
 <div class="box-inner">
  ...
  <br/>
		...
		<form method="post" action="<?php echo base_url(); ?>index.php/admin/tambah_mk" class="form-horizontal">
			<div class="form-group">
				<label class="col-sm-4 control-label">Kode MK</label>
					<div class="col-sm-4 ">
						<input required type="text" class="form-control" name="kd_mk" pattern="[a-zA-Z0-9_]+" placeholder="Kode MK">
					</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label">Nama MK</label>
					<div class="col-sm-4 ">
						<input required type="text" class="form-control" name="nama_mk" placeholder="Nama MK">
					</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label">Jumlah SKS</label>
					<div class="col-sm-4 ">
						<input required type="number" class="form-control" name="jum_sks" placeholder="Jumlah SKS">
					</div>
			</div>
