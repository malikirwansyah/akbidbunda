		...
		<div class="navbar-inner">
		  ...
		  <a class="navbar-brand" href="#"><img src="<?php echo base_url(); ?>asset/bootstrap/img/logo_akbid.png"> </a>
			...
			<ul class="collapse navbar-collapse nav navbar-nav top-menu">
			  ...
			  <li><a href="<?php echo base_url(); ?>index.php/mahasiswa/"><i class="glyphicon glyphicon-book icon-white"></i> Home</a></li>
			 
			  <li><a href="<?php echo base_url(); ?>index.php/mahasiswa/cari"><i class="glyphicon glyphicon-search icon-white"></i> Nilai</a></li>
			...
			<div class="btn-group navbar-form pull-right">
			  ...
			  <ul class="dropdown-menu">
				<li><a href="<?php echo base_url(); ?>index.php/mahasiswa/ganti_password"><i class="icon-wrench"></i> Pengaturan Akun</a></li>
