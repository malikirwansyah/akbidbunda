	...
	?>
	  ...
	  <div class="tab-content">
		<div class="tab-pane <?php echo $a; ?>" id="lA">
			<?php echo form_open('mahasiswa/save_pass','class="form-horizontal"'); ?><br />
				<div class="form-group">
					<label class="col-sm-4 control-label" for="pass_lama">Username</label>
					<div class="col-sm-6 ">
					  <input type="text" value="<?php echo $this->session->userdata('nim'); ?>" 
					  class="form-control" name="nim" placeholder="nim" readonly="true">
					</div>
				</div>
